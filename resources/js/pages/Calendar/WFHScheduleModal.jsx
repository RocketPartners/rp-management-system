...
function generateRecurringDates(recurringDays, recurringMonth) {
...
function SelectedDatesList({ dates, onRemove }) {
    return (
        <>
            <Label className="text-base font-semibold">
...
function RecurringPreview({ dates, recurringDays, recurringMonth }) {
    return (
        <>
